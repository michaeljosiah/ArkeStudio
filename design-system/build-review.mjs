...
const SCREENS = [
  ...
  { group: "Scene workspace", screen: "Storyboard · a row open", frame: "143a", route: "#/w/:worldId/p/:prodId/scenes/:sceneId · a row open", status: "drawn", checked: "2026-09-11",
    ...
    notes: ["Turn 143: pressing a row opens it beneath its head to four panels &#8212; Description, Frame prompt, Notes, Shot settings &#8212; and the other rows fold to 60px. Not built.", "What ships is 139c&#8217;s prompt opening inside a wide row (PR 1092). <code>Aspect ratio</code> and <code>Frame style</code> need the decision 143 records before the selects are built."] },
