...
const SCREENS = [
  ...
  { group: "Scene workspace", screen: "Stage", frame: "144a", route: "#/w/:worldId/p/:prodId/scenes/:sceneId · Stage", status: "built", checked: "2026-09-11",
    controls: ["Build with Arke", "Keep blocking", "Look", "Camera", "Keep", "Loop", "Add set", "Turn with target"],
    notes: ["Built by PR 900 and the 1040–1051 series; drawn first in 140a, and the panel redrawn as an inspector in 144a — the stage list, one form for the selection, one field grammar — which PR 1104 builds.", "Round-57 findings are in issue 1094."] },
