...
const SCREENS = [
  ...
  { group: "Scene workspace", screen: "Storyboard · List", frame: "139a", route: "#/w/:worldId/p/:prodId/scenes/:sceneId", status: "drifted", checked: "2026-09-11",
    controls: ["Review scene", "Generate frames", "Frame prompt", "Regenerate", "Generate frame", "List", "Grid"],
    notes: ["Built by PR 1092 to the 138 bitmap, to the pixel: 30px title, 19px shot titles, 15px script, 40px buttons, 44px tiles.", "Turn 139's scale (24 / 15 / 13 / 11, 36px buttons, 36px tiles) is drawn, not built — issue 1096 A. The image box, gutter and hover toolbar ship as drawn."] },
  { group: "Scene workspace", screen: "Storyboard · a row open", frame: "143a", route: "#/w/:worldId/p/:prodId/scenes/:sceneId · a row open", status: "drifted", checked: "2026-09-11",
    controls: ["Description", "Frame prompt", "View full prompt", "Notes", "Shot settings", "Duration", "Aspect ratio", "Frame style", "Regenerate", "Generate frame"],
    notes: ["Built to 143a: a press opens the row to Description, Frame prompt (<code>View full prompt</code>, <code>Rebuild</code>), Notes and Shot settings, and the other rows fold to 60px; the chevron, Escape and another row close it, and Close waits for a written prompt the way Hide did.", "<code>Frame style</code> is drawn and not built: the shot has no field to bind it to (143&#8217;s last rule). <code>Aspect ratio</code> reads the production&#8217;s and is disabled on the shot."] },
  { group: "Scene workspace", screen: "Storyboard · Grid", frame: "139b", route: "#/w/:worldId/p/:prodId/scenes/:sceneId · Grid", status: "drifted", checked: "2026-09-11",
    controls: ["Grid", "Regenerate", "Needs frame"],
    notes: ["Built by PR 1092 as the same rows in a grid; drawn for the first time in 139b. Same type-scale drift as the List."] },
  { group: "Scene workspace", screen: "Shot row · Frame prompt", frame: "139c", route: "rows.tsx", status: "drifted", checked: "2026-09-11",
    controls: ["Authored", "Rebuild", "Hide", "image prompt"],
    notes: ["Collapsed at rest with <code>Authored</code>, open with <code>Rebuild</code> and <code>Hide</code> — ships.", "The prompt shown is assembled for the video capability and labelled <i>image prompt</i>; the frame run sends the image-capability prompt (issue 1096 B3)."] },
  ...
  { group: "Scene workspace", screen: "Stage", frame: "140a", route: "#/w/:worldId/p/:prodId/scenes/:sceneId · Stage", status: "drifted", checked: "2026-09-11",
    controls: ["Build with Arke", "Keep blocking", "Look", "Camera", "Keep", "Loop", "Export playblast", "Render with this"],
    notes: ["Built by PR 900 and the 1040–1051 series; drawn for the first time in 140a.", "The build has 23 distinct type sizes on this screen and a 14px/10px mix in the panel (issue 1096 A); turn 140 binds 12px throughout. The blockout line's model caption is still a caption (turn 137). Round-57 findings are in issue 1094."] },
  { group: "Scene workspace", screen: "Stage · full screen", frame: "140b", route: "… · Stage · full screen", status: "built", checked: "2026-09-11",
    controls: ["Esc", "Build with Arke", "Render with this"],
    notes: ["Issue 1078 gave the Stage the Flow's full screen; polish is issue 1094."] },
