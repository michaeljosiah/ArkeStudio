...
const SCREENS = [
  ...
  { group: "Scene workspace", screen: "Storyboard · a row open", frame: "143a", route: "#/w/:worldId/p/:prodId/scenes/:sceneId · a row open", status: "built", checked: "2026-09-11",
    controls: ["Description", "Frame prompt", "View full prompt", "Notes", "Shot settings", "Duration", "Aspect ratio", "Regenerate", "Generate frame"],
    notes: ["Built to 143a: a press opens the row to Description, Frame prompt (<code>View full prompt</code>, <code>Rebuild</code>), Notes and Shot settings, and the other rows fold to 60px; the chevron, Escape and another row close it, and Close waits for a written prompt the way Hide did.", "<code>Aspect ratio</code> reads the production&#8217;s and is disabled on the shot. The mock&#8217;s <code>Frame style</code> was dropped from the drawing on 11 September: no field behind it."] },
