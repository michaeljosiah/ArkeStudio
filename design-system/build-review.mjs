...
const SCREENS = [
  ...
  { group: "Around it", screen: "Arke account", frame: "151a", route: "the picture after the gear, over any screen", status: "drawn", checked: "2026-09-17",
    controls: ["Upgrade", "Account", "Sign out"],
    notes: ["Turn 151, ahead of Arke cloud: the account as the last control in the chrome's right group, a 300-wide menu with account things only — the person, <code>Plan</code> with its one action, <code>Account</code>, <code>Sign out</code> — and the states in 151c. Not built; the spec is owed with the build (SPEC-025 keeps accounts out of Studio)."] },
  { group: "Around it", screen: "Arke account · signed out", frame: "151b", route: "the person glyph after the gear, over any screen", status: "drawn", checked: "2026-09-17",
    controls: ["Sign in", "Create account"],
    notes: ["Turn 151: the same menu with no one signed in — one title and two buttons, both a browser handoff. Quiet in the chrome: no dot, no badge, nothing local gated. Not built."] },
