...
const SCREENS = [
  ...
  { group: "Scene workspace", screen: "Storyboard · List", frame: "145a", route: "#/w/:worldId/p/:prodId/scenes/:sceneId", status: "drifted", checked: "2026-09-12",
    ...
    notes: ["Built by PR 1092 to the 138 bitmap and PR 1102 to 143a: the row unfolds in place to Description, Frame prompt, Notes and Shot settings, and the others fold to 60px.", "Turn 145 draws the row as a row: the script typed on it, no <code>Frame prompt</code> toggle, no unfolding, a chevron that opens the shot page, and <code>Storyboard &middot; Flow &middot; Preview</code> with the Stage gone to the page. Drawn, not built. Turn 139's scale is still issue 1096 A."] },
  ...
  { group: "Scene workspace", screen: "Storyboard · Grid", frame: "145f", route: "#/w/:worldId/p/:prodId/scenes/:sceneId · Grid", status: "drifted", checked: "2026-09-12",
    ...
    notes: ["Built by PR 1092 as the same rows in a grid; drawn for the first time in 139b. Same type-scale drift as the List.", "Turn 145 redraws the card without the <code>Frame prompt</code> toggle and with a chevron on the foot; a press on the card opens the shot page (145f). Drawn, not built."] },
