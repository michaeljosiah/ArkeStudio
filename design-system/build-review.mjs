...
const SCREENS = [
  ...
  { group: "Around it", screen: "Chapter · audiobook view (story)", frame: "146b", route: "#/w/:worldId/p/:prodId/story/chapters/:id?view=audiobook", status: "drifted", checked: "2026-09-14",
    ...
    notes: ["SPEC-047 slice 1 ships the view: the <code>Manuscript · Audiobook</code> row, the blocks with a state each, <code>Read the chapter</code> with its count and price, the price asked once, the player over made takes, the block pressed and its takes beside it.", "Not built yet: the block's direction (delivery, phrase, speed, cues) and <code>Direct this chapter</code> — slice 2."] },
