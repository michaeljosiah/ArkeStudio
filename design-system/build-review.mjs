...
const SCREENS = [
  ...
  { group: "Around it", screen: "Arke account · signed out", frame: "151b", route: "the person glyph after the gear, over any screen", status: "built", checked: "2026-09-17",
    ...
    notes: ["Turn 151: the same menu with no one signed in — one title and two buttons, both a browser handoff. Quiet in the chrome: no dot, no badge, nothing local gated.", "Built; with <code>NoArkeCloud</code> either door answers <code>Arke cloud is not available yet</code> under the title, and the line goes with the menu."] },
