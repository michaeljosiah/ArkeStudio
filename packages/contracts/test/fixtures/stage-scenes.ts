...
export const stageFixtures: Array<{name:string;duration:number;stage:ResolvedShotStaging}> = [
  ...
  {name:"eased-action",duration:6,stage:{version:1,cast:[{sheetId:"actor",x:-1,z:0}],sets:[],keys:hold(6,[0,1.5,5],[0,1.1,0]),performances:[{sheetId:"actor",keys:[{t:0,x:-1,z:0,hold:1,easeOut:.25},{t:3,x:0,z:-.5,facing:90,easeIn:.25,easeOut:.25},{t:5,x:1,z:0,facing:180,easeIn:.25},{t:6,x:1,z:0,facing:180,pose:"sit"}]}]}},
