...
// Thirty-three is a direction's markers and its words on the chapter's audiobook record (SPEC-047 R-40, R-43).
// Thirty-four is the performed reading, its notes and the book's narrator (SPEC-047 R-44..R-46).
