...
fields.narrative is {question?,direction?,ending?,arcNotes?}; direction is the through-line. Arcs are [{id,title,note?,setup?:episodeKey,turn?:episodeKey,payoff?:episodeKey}]. Micro drama owns episodes; other kinds own scenes directly. A scene belongs to exactly one episode in micro drama. Do not invent shots or media.
