...
Put stated episode duration bounds into fields.defaults. Durations and the hook window are in seconds; exportPreset is a string. Choosing microdrama seeds missing delivery defaults; the author's explicit values take precedence.
