        ...
        <div className="fy-bench__composer">
          ...
          <div className="fy-bench__dispatch">
            ...
            {characterAudio && <div aria-label="Character audio references" style={{ flexBasis: "100%" }}>
              ...
              {characterAudio.references.map(r => <p key={r.sheetId}>{r.characterName} · {r.label} · {r.sample.provenance.outputTechnical.durationSec?.toFixed(1)}s · voice guidance, new scene dialogue</p>)}
