...
export function BenchBrief({
  ...
  // The menu hangs off the query itself, measured on the invisible copy of the words. Below the
  // line where there is room and above it where there is not, and never off the side.
  useLayoutEffect(() => {
    if (!open) {
      setAnchor(null);
      return;
