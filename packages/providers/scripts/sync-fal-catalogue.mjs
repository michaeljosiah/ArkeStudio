...
const CURATED = {
  ...
  "fal-ai/nano-banana-2": {
    id: "nano-banana-2",
    capability: "image",
    accepts: { referenceImages: 6, startFrame: false, endFrame: false },
  ...
  "fal-ai/veo3.1/fast": {
    id: "veo-3.1-fast",
    capability: "video",
    accepts: { referenceImages: 3, startFrame: true, endFrame: false },
    limits: { maxDurationSec: 8, resolutions: ["720p"], aspects: ["16:9", "9:16"] },
  },
  "fal-ai/kling-video/v3/pro/text-to-video": {
    id: "kling-3-pro",
    capability: "video",
    accepts: { referenceImages: 1, startFrame: true, endFrame: true },
    limits: { maxDurationSec: 10, resolutions: ["1080p"], aspects: ["16:9", "9:16", "1:1"] },
  },
  "fal-ai/kling-video/v3/standard/text-to-video": {
    id: "kling-3-standard",
    capability: "video",
    accepts: { referenceImages: 1, startFrame: true, endFrame: false },
