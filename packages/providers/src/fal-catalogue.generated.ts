...
// Catalogue size at generation: 1504 models. Regenerate when fal ships something worth having.
...
export const FAL_MODELS: readonly ManifestModel[] = [
  ...
  },
  {
    ...
    "limits": {
      ...
      "maxReferenceVideoBytes": 50000000,
      "referenceVideoPixels": {
        "min": 409600,
        "max": 927408
      },
