...
| 26a Activity | 4 | (icon only) x3, Set |
...
| 53c The episode · its promise, then its scenes | 3 | (icon only) x2, Episode 3 |
| 49a Script · before coverage exists | 3 | (icon only) x2, 11 · The answer from inside |
| 51b Stale, by panel | 3 | (icon only) x2, 11 · The answer from inside |
| 48a Season · the question and the engine | 3 | (icon only) x2, Story v1 |
| 48c Direction · the season against the world look | 3 | (icon only) x2, Story v1 |
...
| 44a Story · the conversation and the overview it shapes | 2 | Story v2, (icon only) |
| 44b Story · before there is an overview | 2 | Story ·, (icon only) |
...
| 34c Game story overview | 1 | (icon only) |
| 34h Talk it through repair | 1 | (icon only) |
| 35b Experience dashboard | 1 | Dashboard |
| 35c Dual-layer graph | 1 | Add |
| 35d Clip inspector | 1 | (icon only) |
