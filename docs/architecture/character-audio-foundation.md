...
Remaining source integration is reviewed range preparation and #256 master-track slices; full-clip reuse does not silently shorten or regenerate an over-budget performance.
