...
| Stage timeline controls (issue 1040) | client `screens/scene-workspace/stage.tsx`: pointer scrubbing, local keyboard shortcuts and optional looping; frame stepping uses contracts `STAGE_FRAME_RATE` | client `test/scene-stage.test.tsx` |
